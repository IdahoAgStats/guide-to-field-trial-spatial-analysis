...
proc sgplot data=alliance;
	styleattrs datacolors=(red  blue green yellow) datalinepatterns=(solid dash);
...
Using the lag bdistance and maximum lag values obtained in the previous steps, we can now estimate an empirical variogram (via the **compute** statement) as described in Section 2.
...
```{r SAS10, engine="sashtml", engine.path=saspath, include=TRUE, engine.opts=sasopts, comment=""}
