...
print("Exponential"); attr(Nin_variofit1a, "SSErr")
print("Spherical"); attr(Nin_variofit2a, "SSErr")
print("Gaussian"); attr(Nin_variofit3a, "SSErr")
print("Matern"); attr(Nin_variofit4a, "SSErr")
```
