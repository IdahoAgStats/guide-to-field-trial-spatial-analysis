...
The variables "gen" refers to the cultivar or breeding line being trialed, and "rep" is the block, and the dependent variable, "yield" is grain yield. Basic exploratory analysis was conducted in \@ref(example-analysis). 
...
preds.ar1ar1 <- predict(nin.ar1ar1, classify = 'gen')$pvals 
```
