---
title: "Stroup NIN Analysis"
author: "Statistical Programs, University of Idaho"
date: "6/9/2021"
output: 
  html_document:
    toc: true
    css: C:\Users\bprice\Dropbox\CLASS\sas.default.css
---
...
### 4.1.1 Plots: Produce Heatmap and Trend Plots over the Field.
...
## 4.2 Estimating and Testing spatial correlation
### 4.2.1 Capture Model Residuals for Spatial Modeling
...
### 4.2.2 Examine the Number of Distance Pairs and Maximum Lags between Residuals
...
### 4.2.3 Compute Moran's I and Geary's C.
...
### 4.3.2 Fitting a theoretical Variogram Model

In Section 3, several theoretical variogram models were described. We can use **Proc Variogram** to fit and compare any number of these models. In the code below, the Gaussian, Exponential, Power, and Spherical models are fit using the **model** statement.<br><br>
...
## 4.4 Using the Estimated variogram in an Adjusted Analysis
...
### 4.4.2 Run Adjusted Model using Gaussian Model
