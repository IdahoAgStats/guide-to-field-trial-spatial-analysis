...
All packages aside from **[inla]((https://www.r-inla.org)** and **breedR** are available on CRAN. Download instructions for **inla** can be found [here](https://www.r-inla.org/download-install). The package **breedR**, availabe on GitHub can be installed within R with the following code:
