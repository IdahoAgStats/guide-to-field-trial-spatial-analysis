...
This tutorial was built using R version 4.1 ("Camp Pontanezen"). Session information is provided at the end of each R-focused chapter on the packages loaded and their versions. 
...
|emmeans| extracts treatments means |
|SpATS | spatial splines for field trials |
|inla | Bayesian modeling with AR1xAR1 approximation |

All packages aside from **[inla]((https://www.r-inla.org)** are available on CRAN. Download instructions for **inla** can be found [here](https://www.r-inla.org/download-install). 

## SAS Requirements

In order to run the SAS portion of this tutorial, a valid copy of SAS software and a current SAS license are required. This tutorial was built using SAS 9.4. Although older versions of SAS may also work, we have not evaluated this. Users can also consider downloading and using a free version of [SAS Studio](https://support.sas.com/downloads/package.htm?pid=1924). The SAS scripts in this tutorial have not been tested on SAS Studio. 
