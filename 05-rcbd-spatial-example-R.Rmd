...
A Matern error function is not available in **nlme**, but the packge **spaMM* has written an extension implementing the Matérn covariance structure. 
...
[spAMM tutorial](https://raw.githubusercontent.com/f-rousset/spaMM-ref/master/vignettePlus/MixedModels_useR2021.pdf)
